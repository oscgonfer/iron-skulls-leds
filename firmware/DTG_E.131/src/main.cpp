...
#define NUM_LEDS_PER_STRIP 680 //170 per universe //680 default (ISC is 480)
#define NUM_STRIPS 1 //make sure pin list is accurate
#define DMX_SUBNET 0

int unsigned DMX_UNIVERSE = 1; //**Start** universe 1, 9, 17, 25, 33, 41
int unsigned UNIVERSE_COUNT = 3; //How Many Universes 8, 8, 8, 4, 8, 8
...
byte pinList[numPins] = {34}; //pinout order for DTG WS2811
